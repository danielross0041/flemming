                            ...
                            <form action=" {{ route('store.order') }}" method="POST">
                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <input type="date" placeholder="Date" name="date" value="{{ date('Y-m-d')}}" id="date">
                                        <span class="text-danger" style="font-weight:bold; font-style:italic; font-family:calibri;">
    ...
    <script>
        ...
        $('.addproduct').click(function(){
            ...
            $('#addproductrow').find('tbody').append('<tr>\
                ...
                <td><input type="number" class="mixfactor" data-key="'+key+'" value="1" placeholder="-" name="mix_factor[]"></td>\
            ...
            unittotal += parseFloat(proprice);
            creditcardtotal += parseFloat(proprice);
            $('#price_total').text(unittotal.toFixed(2));
            $('#credit_card_total').text(creditcardtotal.toFixed(2));
            var unit = 0;
        ...
        $(document).on("click","#add_product",function() {
            ...
            var credit_card_total = creditcardtotal;
            var item_desc = [];
