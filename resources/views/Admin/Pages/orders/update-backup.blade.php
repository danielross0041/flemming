                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                        ...
                                        <select name="location" class="black location" id="state">
                                            ...
                                            <option value="Lake Canroe" {{($order->location == 'Lake Canroe'?'selected':'')}}>Lake Canroe</option>
                                                ...
                                                <div class="accord_order_table">
                                                    ...
                                                    <table id="addproductrow{{$j}}" class="table table-striped table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @php
                                                            $str_arr = explode ("[", $item->item_desc);
                                                            @endphp
                                                            @if (ucwords($make->name[0]) == $str_arr[1][0])
                                                            <?php
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <div class="d-flex align-items-center">
                                                                        <i class="fas fa-times-circle removerow" data-key="{{$j}}"></i>
                                                                        <p>{{$item->item_desc}}</p>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td><input type="number" class="gameunit" data-key="{{$j}}"  value="{{$item->game_units}}" name="game_units[]"></td>
                                                                <td><input type="number" class="mixfactor" data-key="{{$j}}" value="{{$item->mix_factor}}"  name="mix_factor[]"></td>
                                                                ...
                                                                <td><input type="number" class="totalprice{{$j}}" value="{{$item->item_total}}"  disabled name="item_total[]"></td>
                                                            </tr>
                                                            @endif
                                                            @endforeach
                                                        </tbody>
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p id="price_unit_total{{$j}}">{{$priceUnit}}</p>
                                                                </td>
                                                                <td>
                                                                    <p>-</p>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <p id="price_total{{$j}}">{{$itemTotal}}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td>
                                                                    <p id="credit_card_total{{$j}}">{{$credit_total?? '0'}}</p>
                                                                    @php
                                                                    $credit_total = 0;
                                                                    @endphp
                                                                </td>
    ...
    <script>
        ...
        <?php foreach ($makes as $k => $value): ?>
            ...
            <?php foreach ($order->orderItems as $index => $item): ?>
                <?php $str_arr = explode ("[", $item->item_desc); ?>
                <?php if (ucwords($value->name[0]) == $str_arr[1][0]): ?>
                    unittotal[{{$k}}]  += {{$item->item_total}};
                    creditcardtotal[{{$k}}] = {{$order->total}};
                <?php endif ?>
            <?php endforeach ?>
        <?php endforeach ?>
